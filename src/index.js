...
let letra;
 ...
 //alert (ss);
 document.getElementById("salida_etiq").textContent = ss ;  //innerHTML tambien se puede
 //document.getElementById("salida_etiq").textContent = cipher.encode(off,entrada) ;
 }
